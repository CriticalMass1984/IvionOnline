...
int main(int argc, char **argv) {
	...
	printf("Value: %d\n", testVar.Get());
	branch.Append<ivion::Var::Var<int>::SetDelta>(testVar.Set(10));
	...
	branch.Append<ivion::Var::Var<int>::SetDelta>(testVar.Set(20));
	branch.Append<ivion::Var::Var<int>::SetDelta>(testVar.Set(30));
	branch.Append<ivion::Var::Var<int>::SetDelta>(testVar.Set(40));
